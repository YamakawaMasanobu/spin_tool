...
while(line):
    ...
    if proc_mo != None:
        ...
        if l_lc_mo.group(2) in proc_dict_forchk[proc_num][source_mo.group(4)]:
            ...
            proc_dict_forers[process_name][l_lc_mo.group(2)] = [l_lc_mo.group(4)]
            proc_dict_forchk[proc_num][source_mo.group(4)] = [l_lc_mo.group(2) + ". " + l_lc_mo.group(4)]
